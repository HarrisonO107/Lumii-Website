          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="rounded-full overflow-hidden" style={{ width: 92, height: 92, border: `2px solid ${L.line}`, boxShadow: `0 14px 40px -12px ${L.glow}` }}>
                ...
                <video src="/video/suki-hero.mp4?v=2" poster="/video/suki-hero-poster.jpg?v=2" autoPlay loop muted playsInline aria-hidden className="w-full h-full object-cover" style={{ objectPosition: "center 28%" }} />
              </div>
